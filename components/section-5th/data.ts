...
export const cardData: cardType[] = [
  {
    title: "token",
    tagline: "The Gateway token to the world of AI",
    image_url: "/images/section-5th-1.png",
    description:
  ...
  {
    title: "revenue",
    tagline: "Driving income and growth through decentralization",
    image_url: "/images/section-5th-2.png",
    description:
  ...
  {
    title: "launchpad",
    tagline: "Driving the future of AI InnovationI",
    image_url: "/images/section-5th-3.png",
    description:
